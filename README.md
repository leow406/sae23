Les objectifs de cette SAE23 sont de développer un outil de support pour le service informatique de l'université via un site web de gestion de tickets de support. Voici les objectifs de cette SAE :
